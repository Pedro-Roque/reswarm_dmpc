...
bearings = {'f1': [-0.8, 0.0, 0.0]}
traj_start = [0.5, -0.5, -0.76]
qd = [0, 0, -0.707, 0.707]
traj_velocity_1 = {'t1': [0.0, 0.01, 0.0], 't2': [0.02, 0.01, 0.0]}
traj_velocity_2 = {'t2': [0.02, 0.01, 0.0]}
                    ...
                    for ww in ww_l:
                        for wf in wf_l:
                            for wt in wt_l:
                                ...
                                file_name = 'leader_iface_gnd_3' + str(profile) + "{:03d}".format(setting_counter)
