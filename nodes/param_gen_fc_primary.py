# Generator for unit tests - primary
import json
...
targets_t1 = {'t':
                    {
                        't1': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't2': [10.95, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0], 
                        't3': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't4': [10.75, -8.75, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't5': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0], 
                        't6': [10.75, -8.5, 4.55, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't7': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0]
                    }
                }
...
targets_t2 = {'q':
                    {
                        't1': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't2': [10.75, -8.5, 4.3, 0, 0, 0, 0.183, 0.183, -0.683, 0.683, 0, 0, 0],
                        't3': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't4': [10.75, -8.5, 4.3, 0, 0, 0, -0.183, 0.183, -0.683, 0.683, 0, 0, 0],
                        't5': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
                        't6': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.500, 0.866, 0, 0, 0],
                        't7': [10.75, -8.5, 4.3, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0]
                    }
                }
...
qd = [0, 0, -0.707, 0.707]
traj_velocity_1 = {'t1': [0, -0.01, 0]}
traj_velocity_2 = {'t2': [0.03, -0.005, 0.03]}
traj_velocity_3 = {'t1': [0, -0.01, 0], 't2': [0.03, -0.005, 0.03]}
                ...
                for ww in ww_l:
                    for wf in wf_l:
                        for wt in wt_l:
                            ...
                            file_name = 'test_'+test_type+'_iss_'+str(profile)+"{:02d}".format(setting_counter)
