...
targets_t1 = {'t': {
    't1': [0.5, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
    't2': [0.1, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
    't3': [0.5, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
    't4': [0.5, -0.1, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
    't5': [0.5, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0]}
              }

targets_t2 = {'q': {
    't1': [0.5, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0],
    't2': [0.5, -0.5, -0.67, 0, 0, 0, 0.0, 0.0, -0.500, 0.866, 0, 0, 0],
    't3': [0.5, -0.5, -0.67, 0, 0, 0, 0, 0, -0.707, 0.707, 0, 0, 0]}
              }
                ...
                for ww in ww_l:
                    for wf in wf_l:
                        for wt in wt_l:
                            ...
                            file_name = 'test_' + test_type + '_gnd_' + str(test) + "{:02d}".format(setting_counter)
