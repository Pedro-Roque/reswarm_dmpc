...
class MPC(object):
    ...
    def __init__(self, model, dynamics,
        ...
        opt_var = ctools.struct_symMX([(
                ...
                ctools.entry('s', shape=(self.Nu,), repeat=self.Nt)
        )])
