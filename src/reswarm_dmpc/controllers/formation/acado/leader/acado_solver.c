...
acadoWorkspace.state[456] = acadoVariables.u[lRun1 * 4];
acadoWorkspace.state[457] = acadoVariables.u[lRun1 * 4 + 1];
acadoWorkspace.state[458] = acadoVariables.u[lRun1 * 4 + 2];
acadoWorkspace.state[459] = acadoVariables.u[lRun1 * 4 + 3];
acadoWorkspace.state[460] = acadoVariables.od[lRun1 * 10];
acadoWorkspace.state[461] = acadoVariables.od[lRun1 * 10 + 1];
acadoWorkspace.state[462] = acadoVariables.od[lRun1 * 10 + 2];
acadoWorkspace.state[463] = acadoVariables.od[lRun1 * 10 + 3];
acadoWorkspace.state[464] = acadoVariables.od[lRun1 * 10 + 4];
acadoWorkspace.state[465] = acadoVariables.od[lRun1 * 10 + 5];
acadoWorkspace.state[466] = acadoVariables.od[lRun1 * 10 + 6];
acadoWorkspace.state[467] = acadoVariables.od[lRun1 * 10 + 7];
acadoWorkspace.state[468] = acadoVariables.od[lRun1 * 10 + 8];
acadoWorkspace.state[469] = acadoVariables.od[lRun1 * 10 + 9];
...
acadoWorkspace.evGu[lRun1 * 76] = acadoWorkspace.state[380];
acadoWorkspace.evGu[lRun1 * 76 + 1] = acadoWorkspace.state[381];
acadoWorkspace.evGu[lRun1 * 76 + 2] = acadoWorkspace.state[382];
acadoWorkspace.evGu[lRun1 * 76 + 3] = acadoWorkspace.state[383];
acadoWorkspace.evGu[lRun1 * 76 + 4] = acadoWorkspace.state[384];
acadoWorkspace.evGu[lRun1 * 76 + 5] = acadoWorkspace.state[385];
acadoWorkspace.evGu[lRun1 * 76 + 6] = acadoWorkspace.state[386];
acadoWorkspace.evGu[lRun1 * 76 + 7] = acadoWorkspace.state[387];
acadoWorkspace.evGu[lRun1 * 76 + 8] = acadoWorkspace.state[388];
acadoWorkspace.evGu[lRun1 * 76 + 9] = acadoWorkspace.state[389];
acadoWorkspace.evGu[lRun1 * 76 + 10] = acadoWorkspace.state[390];
acadoWorkspace.evGu[lRun1 * 76 + 11] = acadoWorkspace.state[391];
acadoWorkspace.evGu[lRun1 * 76 + 12] = acadoWorkspace.state[392];
acadoWorkspace.evGu[lRun1 * 76 + 13] = acadoWorkspace.state[393];
acadoWorkspace.evGu[lRun1 * 76 + 14] = acadoWorkspace.state[394];
acadoWorkspace.evGu[lRun1 * 76 + 15] = acadoWorkspace.state[395];
acadoWorkspace.evGu[lRun1 * 76 + 16] = acadoWorkspace.state[396];
acadoWorkspace.evGu[lRun1 * 76 + 17] = acadoWorkspace.state[397];
acadoWorkspace.evGu[lRun1 * 76 + 18] = acadoWorkspace.state[398];
acadoWorkspace.evGu[lRun1 * 76 + 19] = acadoWorkspace.state[399];
acadoWorkspace.evGu[lRun1 * 76 + 20] = acadoWorkspace.state[400];
acadoWorkspace.evGu[lRun1 * 76 + 21] = acadoWorkspace.state[401];
acadoWorkspace.evGu[lRun1 * 76 + 22] = acadoWorkspace.state[402];
acadoWorkspace.evGu[lRun1 * 76 + 23] = acadoWorkspace.state[403];
acadoWorkspace.evGu[lRun1 * 76 + 24] = acadoWorkspace.state[404];
acadoWorkspace.evGu[lRun1 * 76 + 25] = acadoWorkspace.state[405];
acadoWorkspace.evGu[lRun1 * 76 + 26] = acadoWorkspace.state[406];
acadoWorkspace.evGu[lRun1 * 76 + 27] = acadoWorkspace.state[407];
acadoWorkspace.evGu[lRun1 * 76 + 28] = acadoWorkspace.state[408];
acadoWorkspace.evGu[lRun1 * 76 + 29] = acadoWorkspace.state[409];
acadoWorkspace.evGu[lRun1 * 76 + 30] = acadoWorkspace.state[410];
acadoWorkspace.evGu[lRun1 * 76 + 31] = acadoWorkspace.state[411];
acadoWorkspace.evGu[lRun1 * 76 + 32] = acadoWorkspace.state[412];
acadoWorkspace.evGu[lRun1 * 76 + 33] = acadoWorkspace.state[413];
acadoWorkspace.evGu[lRun1 * 76 + 34] = acadoWorkspace.state[414];
acadoWorkspace.evGu[lRun1 * 76 + 35] = acadoWorkspace.state[415];
acadoWorkspace.evGu[lRun1 * 76 + 36] = acadoWorkspace.state[416];
acadoWorkspace.evGu[lRun1 * 76 + 37] = acadoWorkspace.state[417];
acadoWorkspace.evGu[lRun1 * 76 + 38] = acadoWorkspace.state[418];
acadoWorkspace.evGu[lRun1 * 76 + 39] = acadoWorkspace.state[419];
acadoWorkspace.evGu[lRun1 * 76 + 40] = acadoWorkspace.state[420];
acadoWorkspace.evGu[lRun1 * 76 + 41] = acadoWorkspace.state[421];
acadoWorkspace.evGu[lRun1 * 76 + 42] = acadoWorkspace.state[422];
acadoWorkspace.evGu[lRun1 * 76 + 43] = acadoWorkspace.state[423];
acadoWorkspace.evGu[lRun1 * 76 + 44] = acadoWorkspace.state[424];
acadoWorkspace.evGu[lRun1 * 76 + 45] = acadoWorkspace.state[425];
acadoWorkspace.evGu[lRun1 * 76 + 46] = acadoWorkspace.state[426];
acadoWorkspace.evGu[lRun1 * 76 + 47] = acadoWorkspace.state[427];
acadoWorkspace.evGu[lRun1 * 76 + 48] = acadoWorkspace.state[428];
acadoWorkspace.evGu[lRun1 * 76 + 49] = acadoWorkspace.state[429];
acadoWorkspace.evGu[lRun1 * 76 + 50] = acadoWorkspace.state[430];
acadoWorkspace.evGu[lRun1 * 76 + 51] = acadoWorkspace.state[431];
acadoWorkspace.evGu[lRun1 * 76 + 52] = acadoWorkspace.state[432];
acadoWorkspace.evGu[lRun1 * 76 + 53] = acadoWorkspace.state[433];
acadoWorkspace.evGu[lRun1 * 76 + 54] = acadoWorkspace.state[434];
acadoWorkspace.evGu[lRun1 * 76 + 55] = acadoWorkspace.state[435];
acadoWorkspace.evGu[lRun1 * 76 + 56] = acadoWorkspace.state[436];
acadoWorkspace.evGu[lRun1 * 76 + 57] = acadoWorkspace.state[437];
acadoWorkspace.evGu[lRun1 * 76 + 58] = acadoWorkspace.state[438];
acadoWorkspace.evGu[lRun1 * 76 + 59] = acadoWorkspace.state[439];
acadoWorkspace.evGu[lRun1 * 76 + 60] = acadoWorkspace.state[440];
acadoWorkspace.evGu[lRun1 * 76 + 61] = acadoWorkspace.state[441];
acadoWorkspace.evGu[lRun1 * 76 + 62] = acadoWorkspace.state[442];
acadoWorkspace.evGu[lRun1 * 76 + 63] = acadoWorkspace.state[443];
acadoWorkspace.evGu[lRun1 * 76 + 64] = acadoWorkspace.state[444];
acadoWorkspace.evGu[lRun1 * 76 + 65] = acadoWorkspace.state[445];
acadoWorkspace.evGu[lRun1 * 76 + 66] = acadoWorkspace.state[446];
acadoWorkspace.evGu[lRun1 * 76 + 67] = acadoWorkspace.state[447];
acadoWorkspace.evGu[lRun1 * 76 + 68] = acadoWorkspace.state[448];
acadoWorkspace.evGu[lRun1 * 76 + 69] = acadoWorkspace.state[449];
acadoWorkspace.evGu[lRun1 * 76 + 70] = acadoWorkspace.state[450];
acadoWorkspace.evGu[lRun1 * 76 + 71] = acadoWorkspace.state[451];
acadoWorkspace.evGu[lRun1 * 76 + 72] = acadoWorkspace.state[452];
acadoWorkspace.evGu[lRun1 * 76 + 73] = acadoWorkspace.state[453];
acadoWorkspace.evGu[lRun1 * 76 + 74] = acadoWorkspace.state[454];
acadoWorkspace.evGu[lRun1 * 76 + 75] = acadoWorkspace.state[455];
}
return ret;
}
...
out[7] = (xd[4]-od[7]);
out[8] = (xd[5]-od[8]);
out[9] = (((((real_t)(0.0000000000000000e+00)-((((real_t)(-2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))+((((real_t)(2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))/(real_t)(2.0000000000000000e+00))/a[6]);
out[10] = (((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))/a[13]);
out[11] = (((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))/a[20]);
out[12] = ((real_t)(-1.4028300000000000e+01)+u[0]);
out[13] = u[1];
out[14] = u[2];
out[15] = u[3];
...
out[194] = ((((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[8]))+((real_t)(2.0000000000000000e+00)*xd[8]))*a[21])*a[22])-((((((real_t)(0.0000000000000000e+00)-((((real_t)(-2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))+((((real_t)(2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))/(real_t)(2.0000000000000000e+00))*a[31])*a[28]));
out[195] = ((((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[7]))+((real_t)(2.0000000000000000e+00)*xd[7]))*a[21])*a[22])-((((((real_t)(0.0000000000000000e+00)-((((real_t)(-2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))+((((real_t)(2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))/(real_t)(2.0000000000000000e+00))*a[34])*a[28]));
out[196] = (((((real_t)(0.0000000000000000e+00)-((real_t)(-2.0000000000000000e+00)*xd[6]))+((real_t)(2.0000000000000000e+00)*xd[6]))*a[21])*a[22]);
...
out[212] = ((((((real_t)(2.0000000000000000e+00)*xd[8])-((real_t)(2.0000000000000000e+00)*xd[8]))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[41])*a[42]));
out[213] = ((((((real_t)(2.0000000000000000e+00)*xd[9])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[9])))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[45])*a[42]));
out[214] = ((((((real_t)(2.0000000000000000e+00)*xd[6])-((real_t)(2.0000000000000000e+00)*xd[6]))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[48])*a[42]));
out[215] = (((((real_t)(2.0000000000000000e+00)*xd[7])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[7])))*a[35])*a[36]);
...
out[231] = ((((((real_t)(2.0000000000000000e+00)*xd[7])-((real_t)(2.0000000000000000e+00)*xd[7]))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[55])*a[56]));
out[232] = ((((((real_t)(2.0000000000000000e+00)*xd[6])-((real_t)(2.0000000000000000e+00)*xd[6]))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[59])*a[56]));
out[233] = ((((((real_t)(2.0000000000000000e+00)*xd[9])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[9])))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[62])*a[56]));
out[234] = (((((real_t)(2.0000000000000000e+00)*xd[8])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[8])))*a[49])*a[50]);
...
out[190] = ((((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[8]))+((real_t)(2.0000000000000000e+00)*xd[8]))*a[21])*a[22])-((((((real_t)(0.0000000000000000e+00)-((((real_t)(-2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))+((((real_t)(2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))/(real_t)(2.0000000000000000e+00))*a[31])*a[28]));
out[191] = ((((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[7]))+((real_t)(2.0000000000000000e+00)*xd[7]))*a[21])*a[22])-((((((real_t)(0.0000000000000000e+00)-((((real_t)(-2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))+((((real_t)(2.0000000000000000e+00)*xd[6])*xd[9])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[8])))/(real_t)(2.0000000000000000e+00))*a[34])*a[28]));
out[192] = (((((real_t)(0.0000000000000000e+00)-((real_t)(-2.0000000000000000e+00)*xd[6]))+((real_t)(2.0000000000000000e+00)*xd[6]))*a[21])*a[22]);
...
out[206] = (real_t)(0.0000000000000000e+00);
out[207] = (real_t)(0.0000000000000000e+00);
out[208] = ((((((real_t)(2.0000000000000000e+00)*xd[8])-((real_t)(2.0000000000000000e+00)*xd[8]))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[41])*a[42]));
out[209] = ((((((real_t)(2.0000000000000000e+00)*xd[9])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[9])))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[45])*a[42]));
out[210] = ((((((real_t)(2.0000000000000000e+00)*xd[6])-((real_t)(2.0000000000000000e+00)*xd[6]))*a[35])*a[36])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])+(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[8])-(((real_t)(2.0000000000000000e+00)*xd[7])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[48])*a[42]));
out[211] = (((((real_t)(2.0000000000000000e+00)*xd[7])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[7])))*a[35])*a[36]);
...
out[225] = (real_t)(0.0000000000000000e+00);
out[226] = (real_t)(0.0000000000000000e+00);
out[227] = ((((((real_t)(2.0000000000000000e+00)*xd[7])-((real_t)(2.0000000000000000e+00)*xd[7]))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[55])*a[56]));
out[228] = ((((((real_t)(2.0000000000000000e+00)*xd[6])-((real_t)(2.0000000000000000e+00)*xd[6]))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[59])*a[56]));
out[229] = ((((((real_t)(2.0000000000000000e+00)*xd[9])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[9])))*a[49])*a[50])-((((((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])+(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9]))-((((real_t)(2.0000000000000000e+00)*xd[6])*xd[7])-(((real_t)(2.0000000000000000e+00)*xd[8])*xd[9])))/(real_t)(2.0000000000000000e+00))*a[62])*a[56]));
out[230] = (((((real_t)(2.0000000000000000e+00)*xd[8])-((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[8])))*a[49])*a[50]);
...
{
t += + tmpFx[(lRun3 * 19) + (lRun1)]*tmpObjS[(lRun3 * 16) + (lRun2)];
}
tmpQ2[(lRun1 * 16) + (lRun2)] = t;
}
}
for (lRun1 = 0; lRun1 < 19; ++lRun1)
{
...
for (lRun3 = 0; lRun3 < 16; ++lRun3)
{
t += + tmpQ2[(lRun1 * 16) + (lRun3)]*tmpFx[(lRun3 * 19) + (lRun2)];
}
...
acado_setObjQ1Q2( &(acadoWorkspace.objValueOut[ 16 ]), acadoVariables.W, &(acadoWorkspace.Q1[ runObj * 361 ]), &(acadoWorkspace.Q2[ runObj * 304 ]) );
...
QDy1[13] = + Q2[208]*Dy1[0] + Q2[209]*Dy1[1] + Q2[210]*Dy1[2] + Q2[211]*Dy1[3] + Q2[212]*Dy1[4] + Q2[213]*Dy1[5] + Q2[214]*Dy1[6] + Q2[215]*Dy1[7] + Q2[216]*Dy1[8] + Q2[217]*Dy1[9] + Q2[218]*Dy1[10] + Q2[219]*Dy1[11] + Q2[220]*Dy1[12] + Q2[221]*Dy1[13] + Q2[222]*Dy1[14] + Q2[223]*Dy1[15];
QDy1[14] = + Q2[224]*Dy1[0] + Q2[225]*Dy1[1] + Q2[226]*Dy1[2] + Q2[227]*Dy1[3] + Q2[228]*Dy1[4] + Q2[229]*Dy1[5] + Q2[230]*Dy1[6] + Q2[231]*Dy1[7] + Q2[232]*Dy1[8] + Q2[233]*Dy1[9] + Q2[234]*Dy1[10] + Q2[235]*Dy1[11] + Q2[236]*Dy1[12] + Q2[237]*Dy1[13] + Q2[238]*Dy1[14] + Q2[239]*Dy1[15];
QDy1[15] = + Q2[240]*Dy1[0] + Q2[241]*Dy1[1] + Q2[242]*Dy1[2] + Q2[243]*Dy1[3] + Q2[244]*Dy1[4] + Q2[245]*Dy1[5] + Q2[246]*Dy1[6] + Q2[247]*Dy1[7] + Q2[248]*Dy1[8] + Q2[249]*Dy1[9] + Q2[250]*Dy1[10] + Q2[251]*Dy1[11] + Q2[252]*Dy1[12] + Q2[253]*Dy1[13] + Q2[254]*Dy1[14] + Q2[255]*Dy1[15];
QDy1[16] = + Q2[256]*Dy1[0] + Q2[257]*Dy1[1] + Q2[258]*Dy1[2] + Q2[259]*Dy1[3] + Q2[260]*Dy1[4] + Q2[261]*Dy1[5] + Q2[262]*Dy1[6] + Q2[263]*Dy1[7] + Q2[264]*Dy1[8] + Q2[265]*Dy1[9] + Q2[266]*Dy1[10] + Q2[267]*Dy1[11] + Q2[268]*Dy1[12] + Q2[269]*Dy1[13] + Q2[270]*Dy1[14] + Q2[271]*Dy1[15];
QDy1[17] = + Q2[272]*Dy1[0] + Q2[273]*Dy1[1] + Q2[274]*Dy1[2] + Q2[275]*Dy1[3] + Q2[276]*Dy1[4] + Q2[277]*Dy1[5] + Q2[278]*Dy1[6] + Q2[279]*Dy1[7] + Q2[280]*Dy1[8] + Q2[281]*Dy1[9] + Q2[282]*Dy1[10] + Q2[283]*Dy1[11] + Q2[284]*Dy1[12] + Q2[285]*Dy1[13] + Q2[286]*Dy1[14] + Q2[287]*Dy1[15];
QDy1[18] = + Q2[288]*Dy1[0] + Q2[289]*Dy1[1] + Q2[290]*Dy1[2] + Q2[291]*Dy1[3] + Q2[292]*Dy1[4] + Q2[293]*Dy1[5] + Q2[294]*Dy1[6] + Q2[295]*Dy1[7] + Q2[296]*Dy1[8] + Q2[297]*Dy1[9] + Q2[298]*Dy1[10] + Q2[299]*Dy1[11] + Q2[300]*Dy1[12] + Q2[301]*Dy1[13] + Q2[302]*Dy1[14] + Q2[303]*Dy1[15];
}
...
acado_multQDy( &(acadoWorkspace.Q2[ 304 ]), &(acadoWorkspace.Dy[ 16 ]), &(acadoWorkspace.QDy[ 19 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 608 ]), &(acadoWorkspace.Dy[ 32 ]), &(acadoWorkspace.QDy[ 38 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 912 ]), &(acadoWorkspace.Dy[ 48 ]), &(acadoWorkspace.QDy[ 57 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 1216 ]), &(acadoWorkspace.Dy[ 64 ]), &(acadoWorkspace.QDy[ 76 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 1520 ]), &(acadoWorkspace.Dy[ 80 ]), &(acadoWorkspace.QDy[ 95 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 1824 ]), &(acadoWorkspace.Dy[ 96 ]), &(acadoWorkspace.QDy[ 114 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 2128 ]), &(acadoWorkspace.Dy[ 112 ]), &(acadoWorkspace.QDy[ 133 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 2432 ]), &(acadoWorkspace.Dy[ 128 ]), &(acadoWorkspace.QDy[ 152 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 2736 ]), &(acadoWorkspace.Dy[ 144 ]), &(acadoWorkspace.QDy[ 171 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 3040 ]), &(acadoWorkspace.Dy[ 160 ]), &(acadoWorkspace.QDy[ 190 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 3344 ]), &(acadoWorkspace.Dy[ 176 ]), &(acadoWorkspace.QDy[ 209 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 3648 ]), &(acadoWorkspace.Dy[ 192 ]), &(acadoWorkspace.QDy[ 228 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 3952 ]), &(acadoWorkspace.Dy[ 208 ]), &(acadoWorkspace.QDy[ 247 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 4256 ]), &(acadoWorkspace.Dy[ 224 ]), &(acadoWorkspace.QDy[ 266 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 4560 ]), &(acadoWorkspace.Dy[ 240 ]), &(acadoWorkspace.QDy[ 285 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 4864 ]), &(acadoWorkspace.Dy[ 256 ]), &(acadoWorkspace.QDy[ 304 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 5168 ]), &(acadoWorkspace.Dy[ 272 ]), &(acadoWorkspace.QDy[ 323 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 5472 ]), &(acadoWorkspace.Dy[ 288 ]), &(acadoWorkspace.QDy[ 342 ]) );
acado_multQDy( &(acadoWorkspace.Q2[ 5776 ]), &(acadoWorkspace.Dy[ 304 ]), &(acadoWorkspace.QDy[ 361 ]) );
...
acadoWorkspace.state[456] = acadoVariables.u[index * 4];
acadoWorkspace.state[457] = acadoVariables.u[index * 4 + 1];
acadoWorkspace.state[458] = acadoVariables.u[index * 4 + 2];
acadoWorkspace.state[459] = acadoVariables.u[index * 4 + 3];
acadoWorkspace.state[460] = acadoVariables.od[index * 10];
acadoWorkspace.state[461] = acadoVariables.od[index * 10 + 1];
acadoWorkspace.state[462] = acadoVariables.od[index * 10 + 2];
acadoWorkspace.state[463] = acadoVariables.od[index * 10 + 3];
acadoWorkspace.state[464] = acadoVariables.od[index * 10 + 4];
acadoWorkspace.state[465] = acadoVariables.od[index * 10 + 5];
acadoWorkspace.state[466] = acadoVariables.od[index * 10 + 6];
acadoWorkspace.state[467] = acadoVariables.od[index * 10 + 7];
acadoWorkspace.state[468] = acadoVariables.od[index * 10 + 8];
acadoWorkspace.state[469] = acadoVariables.od[index * 10 + 9];
...
if (uEnd != 0)
{
acadoWorkspace.state[456] = uEnd[0];
acadoWorkspace.state[457] = uEnd[1];
acadoWorkspace.state[458] = uEnd[2];
acadoWorkspace.state[459] = uEnd[3];
}
else
{
acadoWorkspace.state[456] = acadoVariables.u[76];
acadoWorkspace.state[457] = acadoVariables.u[77];
acadoWorkspace.state[458] = acadoVariables.u[78];
acadoWorkspace.state[459] = acadoVariables.u[79];
}
acadoWorkspace.state[460] = acadoVariables.od[200];
acadoWorkspace.state[461] = acadoVariables.od[201];
acadoWorkspace.state[462] = acadoVariables.od[202];
acadoWorkspace.state[463] = acadoVariables.od[203];
acadoWorkspace.state[464] = acadoVariables.od[204];
acadoWorkspace.state[465] = acadoVariables.od[205];
acadoWorkspace.state[466] = acadoVariables.od[206];
acadoWorkspace.state[467] = acadoVariables.od[207];
acadoWorkspace.state[468] = acadoVariables.od[208];
acadoWorkspace.state[469] = acadoVariables.od[209];
