 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 15 for first 10 nodes.
 */
real_t y[ 150 ];
...
/** Matrix of size: 160 x 15 (row major format) */
real_t Q2[ 2400 ];

/** Matrix of size: 60 x 6 (row major format) */
real_t R1[ 360 ];

/** Matrix of size: 60 x 15 (row major format) */
real_t R2[ 900 ];
