...
/** Matrix of size: 190 x 6 (row major format) */
real_t evGu[ 1140 ];
...
/** Row vector of size: 420 */
real_t objValueOut[ 420 ];

/** Matrix of size: 190 x 19 (row major format) */
real_t Q1[ 3610 ];

/** Matrix of size: 190 x 21 (row major format) */
real_t Q2[ 3990 ];
...
/** Matrix of size: 1045 x 6 (row major format) */
real_t E[ 6270 ];
